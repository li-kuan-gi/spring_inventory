...
public class ReserveIntegrateTest {
    ...
    void layersConnectForNormalFlow(@Autowired JdbcTemplate jdbcTemplate) {
        ...
        final var response = postRequirements(id, requiredQuantity);
    ...
    private ResponseEntity<Void> postRequirements(UUID id, Integer quantity) {
        ...
        return restTemplate.postForEntity("/reserve", request, Void.class);
    }
